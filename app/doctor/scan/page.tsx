      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center p-6">
              {!scanComplete ? (
                <div className="mb-4 rounded-lg border-2 border-dashed p-8 text-center">
                  ...
                  <p className="mt-4 text-sm font-medium">Scan QR Code</p>
                  <p className="text-xs text-muted-foreground mt-2">Position the QR code within the scanner area</p>
                </div>
              ) : (
            ...
            <CardFooter>
              {!scanComplete ? (
                <Button className="w-full bg-emerald-500 hover:bg-emerald-600" onClick={handleScan}>
                  Start Scanning
                </Button>
              ) : (
                <div className="w-full grid grid-cols-2 gap-2">
                  <Button variant="outline" onClick={() => setScanComplete(false)}>
                    Scan Again
                  </Button>
              ...
              <TabsContent value="vitals">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Patient's vital sign history</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">Last measured: April 12, 2024</p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-2xl font-bold">16 rpm</span>
                          <Badge className="bg-emerald-500">Normal</Badge>
                        </div>
                        <p className="text-xs text-muted-foreground">Last measured: April 12, 2024</p>
                      </div>
